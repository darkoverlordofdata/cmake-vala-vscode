...
namespace Emscripten {
	...
	public int run_script_int(string script);

	[CCode (cname="emscripten_run_script_string")]
	public string run_script_string(string script);

	[CCode (cname="emscripten_async_run_script")]
	public void async_run_script(string script, int millis);

	[CCode (cname="emscripten_set_main_loop")]
	public void set_main_loop(em_arg_callback_func fnc, int fps, int simulate_infinite_loop);

	[CCode (cname="emscripten_set_main_loop_arg")]
	public void set_main_loop_arg(em_arg_callback_func fnc, void* arg, int fps, int simulate_infinite_loop);

	[CCode (cname="emscripten_cancel_main_loop")]
	public void cancel_main_loop();

	[CCode (cname="emscripten_get_main_loop_timing")]
	public int get_main_loop_timing(int* mode, int* value);

	[CCode (cname="emscripten_set_main_loop_timing")]
	public int set_main_loop_timing(int mode, int value);
	...
	public int get_canvas_size(int* width, int* height);

	[CCode (cname="emscripten_set_canvas_size")]
	public int set_canvas_size(int width, int height);
